/*
 * @FilePath: \smart_locker\main\dri\Dri_BLE.c
 * @Description:
 * @Author:  Vesper Shaw (octxgq@gmail.com)
 * @Date: 2025-11-01 15:14:28
 * @LastEditTime: 2025-11-01 23:26:58
 * @LastEditors: Vesper Shaw (octxgq@gmail.com)
 * Copyright (c) 2025 by XXX有限公司, All Rights Reserved.
 */
#include "Dri_BLE.h"

extern void App_Commu_ReceiveData(uint8_t *data, uint16_t len);
...
static char example_device_name[ESP_BLE_ADV_NAME_LEN_MAX] = "smart_locker";
                                        ...
                                        esp_gatt_if_t gatts_if, esp_ble_gatts_cb_param_t *param)
{
    ...
    case ESP_GATTS_WRITE_EVT:
        ...
        App_Commu_ReceiveData(param->write.value, param->write.len);
        break;
